        ...
        foreach ($userRequests as $item) {
            ...
            if ($item->status == Request::STATUS_APPROVED) {
                ...
                if ($item->phone) {
                    ...
                    $textSms2 = "Bugun soat 10:00 da konferensiyaning ochilishida ishtitok eting. Oflayn: TATU, kichik majlislar zali, Onlayn: https://us02web.zoom.us/j/83914614041?pwd=YkVnNlpxblp5ems2eklvbU43SWNFQT09%20 Kirish kodi: 764643 ID zoom: 83914614041.";
