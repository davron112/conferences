...
(function($) {
    ...
    $(document).ready(function() {
        ...
        if ( $('#lgx-countdown').length ) {
            ...
            $('#lgx-countdown').countdown(dataTime, function(event) {
                ...
                var $this = $(this).html(event.strftime(''
                    ...
                    + '<span class="lgx-days">%D <i> Kun </i></span> '

                    + '<span class="lgx-hr">%H <i> Soat </i></span> '

                    + '<span class="lgx-min">%M <i> Daqiqa </i></span> '
        ...
        $('#lgx-submit').on('submit', function (ev) {
        ...
        $contactForm.validate({
            ...
            submitHandler: function (form) {
                ...
                formSend.append('category_id', $('#lgxcategory').val())
                formSend.append('username', $('#lgxusername').val())
                formSend.append('email', $('#lgxemail').val())
                formSend.append('subject', $('#lgxsubject').val())
                formSend.append('note_client', $('#lgxnote_client').val())
                formSend.append('authors', $('#lgxauthors').val())
                formSend.append('file', $('#lgxfile')[0].files[0])
                formSend.append('_token', $('#lgx_token').val())
                formSend.append('conference_id', $('#lgxconference').val())

                console.log(formSend);

                $.ajax({

                    url: lgx_path + '/conferences/create',
