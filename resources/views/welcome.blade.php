                ...
                <div id="lgx-main-slider" class="owl-carousel lgx-slider-navbottom">
                    ...
                    <div class="lgx-item-common">
                        <div class="slider-text-single">
                            <figure>
                                <img src="assets/img/slider6.jpg" alt="slide"/>
                                <figcaption>
                                        ...
                                        <div class="lgx-hover-link">
                                            <div class="lgx-vertical">
                                                ...
                                                <div class="lgx-banner-info"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg--> <!--banner-info-margin-->
                                                    <h3 class="subtitle lgx-delay lgx-fadeInDown">Iqtisodiyotning tarmoqlarini innovatsion rivojlanishida
                                                        axborot-kommunikatsiya texnologiyalarining ahamiyati</h3>
                                                    <h2 class="title lgx-delay lgx-fadeInDown">Anjuman <span><b>2</b><b>0</b><b>2</b><b>1</b></span></h2>
                                                    <h3 class="location lgx-delay lgx-fadeInDown"><i class="fa fa-map-marker"></i> Muhammad al-Xorazmiy nomidagi Toshkent axborot texnologiyalari universiteti</h3>
                                                    <h3 class="date lgx-delay lgx-fadeInDown"><i class="fa fa-calendar"></i> 4-5 Mart, 2021</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="lgx-item-common">
                        <div class="slider-text-single">
                            <figure>
                                <img src="assets/img/slider7.jpg" alt="slide"/>
                                <figcaption>
                                    <div class="lgx-container">
                                        <div class="lgx-hover-link">
                                            <div class="lgx-vertical">
                        ...
                        <div class="lgx-banner-info-area">
                            <div class="lgx-banner-info-circle lgx-info-circle">
                                <div class="info-circle-inner">
                                    <h3 class="date">4 <span>Mart</span></h3>
                                    <div class="lgx-countdown-area">
                                        <!-- Date Format :"Y/m/d" || For Example: 1017/10/5  -->
                                        <div id="lgx-countdown" data-date="2021/03/04"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="lgx-about-content-area">
                                ...
                                <p>
                                    2021 yil 4-5 mart kunlari Muhammad al-Xorazmiy nomidagi Toshkent axborot texnologiyalari universiteti “Iqtisodiyotning tarmoqlarini innovatsion rivojlanishida axborot-kommunikatsiya texnologiyalarining ahamiyati” mavzuidagi Respublika ilmiy-texnik anjumanini o'tkazadi.
                                </p>
                                <div class="lgx-about-content">
                                    Anjuman quyidagi yo'nalishlar bo'yicha  faoliyat yuritadi:
                                    <ul>
...
<!--SPEAKERS-->
<section>
    <div id="lgx-speakers" class="lgx-speakers lgx-speakers4">
        <div class="lgx-inner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
            ...
            <div class="lgx-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                <h2 class="heading">Homiylar</h2>
                                <h3 class="subheading">Homiylar haqida ma'lumot</h3>
                            </div>
                        </div>
                    </div>
                    <!--//main row-->
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="sponsored-heading first-heading">Bizning homiylar</h3>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-registration-area-simple">
                            <div class="lgx-heading lgx-heading-white">
                                <h2 class="heading">ANJUMANDA ISHTIROK ETISH</h2>
                                <h3 class="subheading">Ro'yhatdan o'ting va o'z maqola yoki tezisingizni yuklang. Javob xatini tez orada elektron pochta orqali olasiz</h3>
                            </div>
        ...
        <div class="lgx-inner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-heading">
                            <h2 class="heading">Anjuman o'tkazilishi haqida ma'lumot</h2>
                            <h3 class="subheading">Iqtisodiyotning tarmoqlarini innovatsion rivojlanishida axborot-kommunikatsiya texnologiyalarining ahamiyati</h3>
                        </div>
                    </div>
                    <!--//main COL-->
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-travelinfo-content">
                            <div class="lgx-travelinfo-single" style="text-align: center;">
                                <img src="assets/img/info-icon1.png" alt="location"/>
                                <h3 class="title">Manzil</h3>
                                <p class="info">Toshkent sh., 100202, A.Temur ko'chasi, 108.</p>
                            </div>
                            <div class="lgx-travelinfo-single">
                                <img src="assets/img/info-icon2.png" alt="Transport"/>
                                <h3 class="title">Telefon</h3>
                                <p class="info"><a href="(8-371) 238-64-43">(8-371) 238-64-43</a> </p>
                            </div>
                            <div class="lgx-travelinfo-single">
                                <img src="assets/img/info-icon3.png" alt="Hotel & Restaurant"/>
                                <h3 class="title">Muassasa</h3>
                                <p class="info">Muhammad al-Xorazmiy nomidagi Toshkent axborot texnologiyalari universiteti</p>
                            </div>
                        </div>
                    </div>
                </div>
